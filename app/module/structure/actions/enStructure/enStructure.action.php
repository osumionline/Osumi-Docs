...
class enStructureAction extends OAction {
	/**
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'structure', 'lang' => 'en']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'structure', 'lang' => 'en']));
