...
class enModulesAction extends OAction {
	/**
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'modules', 'lang' => 'en']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'modules', 'lang' => 'en']));
