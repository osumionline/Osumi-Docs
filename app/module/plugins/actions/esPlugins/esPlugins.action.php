...
class esPluginsAction extends OAction {
	/**
	 * Página de Plugins
	 *
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'plugins', 'lang' => 'es']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'plugins', 'lang' => 'es']));
