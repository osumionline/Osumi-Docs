	...
	<main>
		...
		<div class="data-table">
			...
			<div class="data-row">
				...
				<div class="data-default">(no tiene)</div>
				<div class="data-explanation">Nombre de la base de datos a la que conectarse.</div>
			</div>
			<div class="data-row">
				<div class="data-param">charset</div>
				<div class="data-default">utf8mb4</div>
				<div class="data-explanation">Juego de caracteres con los que comunicarse con la base de datos.</div>
			</div>
			<div class="data-row">
				<div class="data-param">collate</div>
				<div class="data-default">utf8mb4_unicode_ci</div>
				<div class="data-explanation">Juego de caracteres para los campos de tipo texto en la base de datos.</div>
			</div>
		</div>
