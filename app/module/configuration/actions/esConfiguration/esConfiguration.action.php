...
class esConfigurationAction extends OAction {
	/**
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'configuration', 'lang' => 'es']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'configuration', 'lang' => 'es']));
