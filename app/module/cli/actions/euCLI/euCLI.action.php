...
class euCLIAction extends OAction {
	/**
	 * Página de CLI (euskara)
	 *
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'cli', 'lang' => 'eu']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'cli', 'lang' => 'eu']));
