...
class enFiltersAction extends OAction {
	/**
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'filters', 'lang' => 'en']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'filters', 'lang' => 'en']));
