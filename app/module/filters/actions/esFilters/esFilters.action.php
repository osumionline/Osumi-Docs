...
class esFiltersAction extends OAction {
	/**
	 * Página de Filtros
	 *
	...
	public function run(ORequest $req):void {
		...
		$this->getTemplate()->add('header',   new HeaderComponent(['page' => 'filters', 'lang' => 'es']));
		$this->getTemplate()->add('menu',     new MenuComponent(['page' => 'filters', 'lang' => 'es']));
