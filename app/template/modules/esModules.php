...
<pre>
	...
	class api extends OController {
		...
		<div class="data-table">
			...
			<div class="data-divider"></div>
			<div class="data-row">
				<div class="data-param">params</div>
	...
	["params"]=>
		array(2) {
			...
			string(6) "123456"
					...
					<br>
					Además de estos campos, el array contendrá los valores de los parámetros dinámicos indicados en la URL.
					<br><br>
					Si en el archivo <code>urls.json</code> se ha definido una URL como <code>/user/<strong>:id</strong></code>, la variable <code>$req['params']</code> contendrá un campo llamado <code>id</code> con el valor de ese parámetro.
					<br><br>
					Por ejemplo:
					<br>
...
<pre>
	...
	$req['params']['id']: "igorosabel"
		...
		<h3>getParam</h3>
		<p>El framework ofrece una serie de funciones para ayudar a la creación de aplicaciones y una de las más usadas en las acciones es una función estática de la clase <code>OTools</code> llamada <code>getParam</code></p>
		<p>Está función acepta tres parámetros:</p>
		<ul>
			<li>Parámetro que se busca, por ejemplo <code>user</code>.</li>
			<li>Lista de parámetros en los que buscar, por ejemplo <code>$req['params']</code>.</li>
...
<pre>
	 ...
	 */
	public function getUserList(array $req): void {
